### load stan library 
setwd("/Users/Harley/Documents/DRC Research/TOHarley/OneDim")
...
datao <- read.csv("drc_3a.csv")
set.seed(124); 								# fix random numbers for reproducibility 
data<-read.csv("drc_3a.csv");
